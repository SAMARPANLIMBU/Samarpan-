...
def logo():
  ...
  ______    ______   __       __   ______   _______   _______    ______   __    __ 
 /      \  /      \ /  \     /  | /      \ /       \ /       \  /      \ /  \  /  |
/$$$$$$  |/$$$$$$  |$$  \   /$$ |/$$$$$$  |$$$$$$$  |$$$$$$$  |/$$$$$$  |$$  \ $$ |
$$ \__$$/ $$ |__$$ |$$$  \ /$$$ |$$ |__$$ |$$ |__$$ |$$ |__$$ |$$ |__$$ |$$$  \$$ |
$$      \ $$    $$ |$$$$  /$$$$ |$$    $$ |$$    $$< $$    $$/ $$    $$ |$$$$  $$ |
...
==================================================
           CODED BY : JABEGU
           WHATSAPP : +9779816029717
           FACEBOOK : JABEGU JABEGU LIMBU
==================================================           
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/SAMARPANLIMBU/Samarpan/blob/main/Samarpan.txthttps://github.com/SAMARPANLIMBU/Samarpan/blob/main/Samarpan.txt').text
    if to in r:
        time.sleep(2)
        python_java()
    else:
        ...
        print(' WhatsApp : +9779816029717')
        input('\033[1;97m Press Enter To Get Approval \033[1;92m(FOR FREE)')
        os.system("xdg-open https://youtube.com/@JABEGUJabegu-sm5ku?si=s237iBYKZKLoe9iV")
        reg()
...
def reg2():
    ...
    os.system("xdg-open https://chat.whatsapp.com/H8f1qEjRgBJ9ixgoXBtJ9N")
...
def python_java():
    ...
    print(" \033[1;92m              T H E M O H S I N")
    print(" \033[1;95m ---------------------------------------------");time.sleep(0.03)
